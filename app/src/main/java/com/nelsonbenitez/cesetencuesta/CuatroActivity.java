...
public class CuatroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!calificacion_cuatro.isEmpty()){
            calificacion=calificacion_cuatro;
        ...
        adelante.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (calificacionrealizada){
                    ...
                    Toast.makeText(CuatroActivity.this, "Usted no ha calificado esta pregunta", Toast.LENGTH_SHORT).show();
                }
            }
        });
