...
public class CuatroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(this, "Recibi de Cinco"+calificacion_cinco, Toast.LENGTH_SHORT).show();

        service = (CircleImageView) findViewById(R.id.service);
        identificaServicioEvaluado(service,servicio);

        estadoEncuenta= (RingProgressBar) findViewById(R.id.progress_bar_4) ;
        estadoEncuenta.setProgress(progress);

        addListenerOnButton();
        seleccionarOpcion(calificacion_cuatro);
    ...
    private void seleccionarOpcion(String opcion_seleccionada) {
        switch (opcion_seleccionada){
            ...
            case "Muy Insatisfecho":
                muy_insatisfecho.setAnimation("chcheck_animationeck.json");
    ...
    private void addListenerOnButton() {
        satisfecho = (LottieAnimationView) findViewById(R.id.satisfecho_cuatro);
        muy_satisfecho = (LottieAnimationView) findViewById(R.id.muy_satisfecho_cuatro);
        insatisfecho = (LottieAnimationView) findViewById(R.id.Insatisfecho_cuatro);
        muy_insatisfecho = (LottieAnimationView) findViewById(R.id.muy_insatisfecho_cuatro);
        ...
        adelante.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (calificacionrealizada){
                    Intent next = new Intent(CuatroActivity.this,CincoActivity.class);
                    ...
                    next.putExtra("calificacion_cuatro",calificacion);
        ...
        atras.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(CuatroActivity.this,TresActivity.class);
                next.putExtra("servicio",servicio);
                next.putExtra("calificacion_uno",calificacion_uno);
                next.putExtra("calificacion_dos",calificacion_dos);
                next.putExtra("calificacion_tres",calificacion_tres);
